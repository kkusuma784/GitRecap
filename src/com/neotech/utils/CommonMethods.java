...
public class CommonMethods extends BaseClass {
	...
	/**
	 * This method will case the driver to JavascriptExecutor objest ans return it
	 * 
	 * @return
	 */
	...
	/**
	 * This method will scrolls the page until a specific elemnt is in view
	 * 
	 * @param element
	 */
	...
	/**
	 * This method scrolls page down using the pixels parameter
	 * 
	 */
	...
	/**
	 * This method scrolls page up using the pixels parameter
	 * 
	 */
	...
	/**
	 * This method will select a date on a calendar whose elements are provides as the 
	 * first paremeter abd select the date that is the second parameter
	 * @param elements
	 * @param date
	 */
